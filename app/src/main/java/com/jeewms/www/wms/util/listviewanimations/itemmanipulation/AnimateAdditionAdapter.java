...
/**
 * An EXPERIMENTAL adapter for inserting rows into the {@link ListView} with an animation. The root {@link BaseAdapter} should implement {@link Insertable},
...
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
    ...
    /**
     * Create a new {@link com.nhaarman.listviewanimations.itemmanipulation.AnimateAdditionAdapter} with given {@link BaseAdapter}.
     *
    ...
    @Deprecated
    /**
     * @deprecated AnimateAdditionAdapter requires a ListView instance. Use {@link #setListView(ListView)} instead.
     */
