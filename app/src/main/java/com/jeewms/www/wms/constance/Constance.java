...
public class Constance {
    ...
    //主界面按钮图片
    public static final int[] btnImgList = {R.drawable.home1,R.drawable.home2, R.drawable.home3, R.drawable.home4, R.drawable.home5, R.drawable.home6,R.drawable.home7
    ,R.drawable.home8,R.drawable.home9,R.drawable.home10,R.drawable.home11,R.drawable.home12};
    //主界面按钮名字
    public static final String[] btnNameList = {"收料通知", "采购入库","工序汇报", "生产入库", "用料清单","生产领料","出库申请","其他出库"
    ,"发货通知","销售出库","库存盘点","扫码查库存"};


    public static void setBaseUrl(String baseUrl) {
        SharedPreferencesUtil.getInstance(App.mContext).setKeyValue(Shared.BASEURL, baseUrl);
    }

    //读取baseurl
    public static String getBaseUrl() {
        return SharedPreferencesUtil.getInstance(App.mContext).getKeyValue(Shared.BASEURL, COMMON_URL);
    }
