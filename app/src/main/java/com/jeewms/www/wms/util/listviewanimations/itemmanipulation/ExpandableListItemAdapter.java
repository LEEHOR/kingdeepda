package com.jeewms.www.wms.util.listviewanimations.itemmanipulation;
...
import com.jeewms.www.wms.util.listviewanimations.ListViewSetter;
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> implements ListViewSetter {
     ...
     * commodity_layout resource for the view; titleParentResId and contentParentResId
     * should be identifiers for ViewGroups within that commodity_layout.
     */
     ...
     * empty list if items == null. Uses given commodity_layout resource for the view;
     * titleParentResId and contentParentResId should be identifiers for
     * ViewGroups within that commodity_layout.
     */
     ...
     * inflate it from an XML commodity_layout file. When the View is inflated, the parent
     * View (GridView, ListView...) will apply default commodity_layout parameters unless
     * you use
