...
import com.jeewms.www.wms.ui.dialog.adapter.StockDialogAdapter;
...
public class StockDialog extends BaseDialogFragment {
    ...
    Unbinder unbinder;
    private StockDialogAdapter adapter;

    private int OFFSET = 0;
    private int SELECTION;

    public static StockDialog newInstance(int selection) {
        StockDialog purchaseOrderAddDialog = new StockDialog();
    ...
    protected void initView() {
        ...
        dialogTitle.setText("仓库选择");
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        adapter = new StockDialogAdapter(R.layout.item_dialog_material_select);
    ...
    protected void initFunc() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                BdStock dataEntity = (BdStock) adapter.getItem(position);
                if (listener != null) {
    ...
    private void searchLike(String s) {
        ...
        List<BdStock> byLike = LitepalSelect.findByLike(BdStock.class, s);
    ...
    public void setListener(StockSelectListener stockSelectListener) {
        this.listener = stockSelectListener;
    }
