 ...
 * @Version: 1.0
 */
public class UnitDialogAdapter extends BaseQuickAdapter<UnitBean.DataEntity, BaseViewHolder> {
    public UnitDialogAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, UnitBean.DataEntity item) {
