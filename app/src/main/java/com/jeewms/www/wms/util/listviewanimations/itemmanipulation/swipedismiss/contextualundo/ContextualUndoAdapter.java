 ...
 */
package com.jeewms.www.wms.util.listviewanimations.itemmanipulation.swipedismiss.contextualundo;
 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link BaseAdapter} to wrap, the undo commodity_layout, the undo button id and a {@link DeleteItemCallback}, optionally a delay time millis,
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
     ...
     * @param undoLayoutId The commodity_layout resource id to show as undo
     ...
     *
     * @param baseAdapter  The {@link BaseAdapter} to wrap
     * @param undoLayoutResId The commodity_layout resource id to show as undo
