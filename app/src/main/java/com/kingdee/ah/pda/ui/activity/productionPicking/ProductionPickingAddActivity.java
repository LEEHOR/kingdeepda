 ...
 * @Version: 1.0
 */
public class ProductionPickingAddActivity extends BaseActivity {
    @BindView(R.id.production_pick_add_title)
    TitleTopOrdersView titleTopOrdersView;

    @Override
    protected int getContentResId() {
        return R.layout.activity_production_picking_add;
    }

    public static void show(Context context) {
        Intent intent = new Intent(context, ProductionPickingAddActivity.class);
