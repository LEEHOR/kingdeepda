package com.kingdee.ah.pda.server;
    ...
    private void createBltService() {
        try {
            if (BluetoothUtil.mBluetoothAdapter() != null) {
                bluetoothServerSocket = BluetoothUtil.mBluetoothAdapter().listenUsingRfcommWithServiceRecord("com.leehor.bluetooth", Constance.SPP_UUID);
            }
        } catch (IOException e) {
        }
    }
        ...
        while (true) {
            try {
                ...
                if (bluetoothSocket != null) {
                    Comment.bluetoothSocket = bluetoothSocket;
