 ...
 */
public class SupplierAdapter extends BaseQuickAdapter<BdSupplier, BaseViewHolder> {
    private int selectedPosition=9999;
    private Context context;
    public SupplierAdapter(Context mContext) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, BdSupplier item) {
    ...
    public void setData(List<BdSupplier> data, int type) {
        if (type == 0) {
            setNewData(data);
        } else {
            addData(data);
